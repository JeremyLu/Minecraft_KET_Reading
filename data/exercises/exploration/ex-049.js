/**
 * mc-ket-049 — Ancient City Warning
 * Category: Exploration & Adventure / 冒险探索
 * Type: Part 1 — Notice Board (3 short notices)
 * Grammar: 祈使句 + must/must not + 方位介词
 * Topic: Ancient City 远古城市 — 深暗之城的警告牌
 */

(function () {
  if (!window.MINECRAFT_KET_DATA) window.MINECRAFT_KET_DATA = {};

  MINECRAFT_KET_DATA["mc-ket-049"] = {
    id: "mc-ket-049",
    ...
    notices: [
      {
        id: "n1",
        text: "DO NOT run! Sculk sensors can hear your footsteps. Walk slowly.",
        visualStyle: "warning",
        impliedGrammar: "must not",
      },
      {
        id: "n2",
        text: "Turn off your Redstone torch. The Warden can smell you in the dark!",
        visualStyle: "danger",
        impliedGrammar: "must",
      },
      {
        id: "n3",
        text: "Do not break the Sculk Shrieker. It will summon the Warden.",
        visualStyle: "warning",
        impliedGrammar: "must not",
      },
    ],
    ...
    answers: [
      ...
      { id: "q2", answer: "B", explanation: "原文 Turn off your Redstone torch，红石火把会吸引监守者。" },
