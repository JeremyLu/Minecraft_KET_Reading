/**
 * mc-ket-059 — Copper Armor Set
 * Category: Survival Basics / 生存基础
 * Type: Part 4 — MCQ Cloze (100 words, 6 gaps × 3 options)
 * Grammar: 比较级 + 被动语态 + 否定句
 * Topic: Copper Armor 铜套 — 1.21.9 官方铜装备，5 护甲值 + 不氧化
 */

(function () {
  if (!window.MINECRAFT_KET_DATA) window.MINECRAFT_KET_DATA = {};

  MINECRAFT_KET_DATA["mc-ket-059"] = {
    id: "mc-ket-059",
