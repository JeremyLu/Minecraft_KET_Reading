/**
 * mc-ket-054 — The Loyal Trident
 * Category: Survival Basics / 生存基础
 * Type: Part 4 — MCQ Cloze (92 words, 6 gaps × 3 options)
 * Grammar: 条件句 + 被动语态 + 时间状语从句
 * Topic: Trident 三叉戟 — 附魔与海洋战斗
 */

(function () {
  if (!window.MINECRAFT_KET_DATA) window.MINECRAFT_KET_DATA = {};

  MINECRAFT_KET_DATA["mc-ket-054"] = {
    id: "mc-ket-054",
