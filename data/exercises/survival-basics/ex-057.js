/**
 * mc-ket-057 — Tipped Arrows
 * Category: Survival Basics / 生存基础
 * Type: Part 4 — MCQ Cloze (98 words, 6 gaps × 3 options)
 * Grammar: 被动语态 + 定语从句 + 目的状语
 * Topic: Tipped Arrows 药箭 — 16 种药水效果箭
 */

(function () {
  if (!window.MINECRAFT_KET_DATA) window.MINECRAFT_KET_DATA = {};

  MINECRAFT_KET_DATA["mc-ket-057"] = {
    id: "mc-ket-057",
