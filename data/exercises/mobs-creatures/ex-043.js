/**
 * mc-ket-043 — The Spider Jockey
 * Category: Mobs & Creatures / 生物图鉴
 * Type: Part 3 — Longer Text (158 words, 5 × MCQ)
 * Grammar: Past Continuous + Past Simple (interrupted action)
 * Topic: 蜘蛛骑士 Spider Jockey — 骷髅骑蜘蛛的罕见遭遇
 */

(function () {
  if (!window.MINECRAFT_KET_DATA) window.MINECRAFT_KET_DATA = {};

  MINECRAFT_KET_DATA["mc-ket-043"] = {
    id: "mc-ket-043",
