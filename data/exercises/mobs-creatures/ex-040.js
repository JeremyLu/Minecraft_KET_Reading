/**
 * mc-ket-040 — The Night Phantom
 * Category: Mobs & Creatures / 生物图鉴
 * Type: Part 4 — MCQ Cloze (82 words, 6 gaps × 3 options)
 * Grammar: 情态动词 must/will/can + 条件状语从句
 * Topic: Phantom 幻翼 — MineCon Earth 票选生物 B，不睡觉的惩罚
 */

(function () {
  if (!window.MINECRAFT_KET_DATA) window.MINECRAFT_KET_DATA = {};

  MINECRAFT_KET_DATA["mc-ket-040"] = {
    id: "mc-ket-040",
