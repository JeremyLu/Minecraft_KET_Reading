/**
 * mc-ket-039 — The Piglin's Gold
 * Category: Mobs & Creatures / 生物图鉴
 * Type: Part 3 — Longer Text (170 words, 5 × MCQ)
 * Grammar: Past Simple + Reported Speech / Dialogue
 * Topic: Piglin 猪灵 — 交易与危险
 */

(function () {
  if (!window.MINECRAFT_KET_DATA) window.MINECRAFT_KET_DATA = {};

  MINECRAFT_KET_DATA["mc-ket-039"] = {
    id: "mc-ket-039",
